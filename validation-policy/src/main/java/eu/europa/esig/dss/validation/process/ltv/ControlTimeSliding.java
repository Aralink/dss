...
public class ControlTimeSliding {
	...
	private ControlTimeSlidingConclusion process(final ProcessParameters params, final XmlDom certificateChain) {
		...
		for (final XmlDom chainCertificate : chainCertificates) {
			 ...
			 * - - ô€€€ The revocation status information is consistent with the rules conditioning its use to check the
			...
			/**
			 * - - ô€€€ The issuance date of the revocation status information is before control-time. If more than one
			...
			/**
			 * - - ô€€€ If the certificate is marked as revoked in the revocation status information, set control-time to the
			 * revocation date.<br>
			 */
			if (revoked) {
				...
				/**
				 * - - ô€€€ If the certificate is not marked as revoked.<br>
